...
<section id="section___main">
    <div class="container">
        ...
        <div id="section___main__presentation">
            <div>
                <h1>Ваш персональный <br>Энерготерапевт - Дарья</h1>
                <p>
                    Чистка и гармонизация вашей энергетики, <br>
                    диагностика негатива, консультация и анализ психосостояния.
                </p>
                <!--
                 <p>
                 ...
                 -->
                <a href="#" class="btn__contact btn__common">Связаться</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <article>
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-5" id="img__about_me_first">
                            <!-- <img src="https://via.placeholder.com/320" alt=""> -->
                            <!--<img src="./assets/media/about/darya_one.webp" alt="darya_one.webp" >-->
                        </div>
                        <div class="col-md-5" id="img__about_me_second">
                            <!-- <img src="https://via.placeholder.com/200" alt=""> -->
                            <!--<img src="./assets/media/about/darya_two.webp" alt="darya_two.webp" >-->
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <p>
                        Я люблю свою работу,
                        для меня дизайн вашего интерьера — это возможность самовыразиться.
                        Мне нравится помогать своим клиентам подчеркнуть их яркие стороны и почувствовать себя уверенней.
                        Вот несколько фактов о моей деятельности:
                    </p>
                    <ul style="margin-left: 0;">
                        <li>Дизайнер с 2020 г.</li>
                        <li>Дизайнер с 2020 г.</li>
                        <li>Дизайнер с 2020 г.</li>
                        <li>Дизайнер с 2020 г.</li>
                        <li>Дизайнер с 2020 г.</li>
...
<section id="section__help_resolve">
    <div class="container">
        <article>
            ...
            <p>Это самые распространенные сложности, с которыми сталкиваются мои клиенты</p>
            <div class="row text-lg-left">
                <div class="col-md-3">
                    <img src="" alt="">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, temporibus.</p>
                </div>
                <div class="col-md-3">
                    <img src="" alt="">
...
<section id="section__blog">
    <div class="container">
        <article>
            <h2>Блог</h2>
            <p>Пишу о моде, гардеробе, создании своего уникального стиля и развитии вкуса</p>
            <div class="blog__photo_gallery">
                some photo gallery
            </div>
        </article>
    </div>
    ...
    <div class="container">
        <article>
            <div id="contact__info">
                ...
                <p class="section__main__social__links__contact">
                    ...
                    <a href="#" class="" title="telegram">
                        <i class="fa fa-telegram" aria-hidden="true"></i>
                    </a>
                </p>
            </div>
            <div>
                <p>Made in russia by developer Jean-Claude</p>
            </div>
        </article>
    </div>
</section>
